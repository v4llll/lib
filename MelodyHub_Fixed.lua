if (game:GetService("CoreGui")):FindFirstChild("Melody") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
...
ImageButton.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=136440813369151";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Melody")).Enabled = not (game.CoreGui:FindFirstChild("Melody")).Enabled;
end);
...
function main:Button(text, callback)
    ...
    -- Configure main button (now clickable)
    Button.Name = "Button";
    Button.Parent = MainFramePage;
    Button.BackgroundColor3 = _G.Primary;
    Button.BackgroundTransparency = 1;
    Button.Size = UDim2.new(1, 0, 0, 36);
    Button.Text = "";  -- No text on main button
    Button.AutoButtonColor = false;  -- Disable default button effects
    ...
    -- Configure clickable button (secondary click area)
    ...
    TextButton.AutoButtonColor = false;  -- Disable default button effects
    ...
    -- Connect click event to main button (entire button is now clickable)
    Button.MouseButton1Click:Connect(function()
        callback();
    end);
end;
